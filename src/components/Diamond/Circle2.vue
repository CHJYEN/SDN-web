...
.circle-one::before {
  ...
  border-radius: 50%;
  aspect-ratio: 1/1;
  background: conic-gradient(var(--ring-color2) 30deg, #ffffff00 0deg);
}
...
.circle-two::before {
  ...
  border-radius: 50%;
  aspect-ratio: 1/1;
  background: conic-gradient(var(--ring-color2) 1deg, #ffffff00 0deg);
}
...
.circle-four::before {
  ...
  aspect-ratio: 1/1;
  background: conic-gradient(var(--ring-color2) 100deg, #ffffff58 0deg);
}
