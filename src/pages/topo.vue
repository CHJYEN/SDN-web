<template>
  <div class="relative p-4" ref="board">
    <BorderBox10 title="HK's SDN Web" :title-width="400" :color="['white', 'white']" :key="width">
      <div class="h-full left-10" ref="panel"></div>
      <div
 ...
 cookie=0x0, duration=7.174s, table=0, n_packets=0, n_bytes=0, priority=1,dl_vlan=0 actions=pop_vlan,output: s2-eth1 '"/>
      ...
      <div
        class="border border-white w-80 h-150 top-80 left-8 absolute p-4"
      >
        ...
        <div class="flexr items-center justify-start">
          ...
          <p class="mypa" style="font-size:5px">{{ networkData.flowtable_text1 }}<br>
            -------------------------------------<br>
